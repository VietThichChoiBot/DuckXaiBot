...
module.exports.handleEvent = async ({ event, api, Currencies,Users, args, utils, global, client }) => {
    ...
    var msg = {
                body: `Bất ngờ chưa ${name} đây là dấu lệnh của bot này : ${global.config.PREFIX}\n Nếu bạn cần giúp đỡ về lệnh hãy dùng ${global.config.PREFIX}menu + lệnh để xem cách dùng`,
