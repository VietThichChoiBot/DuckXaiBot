...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`梁Admin Bot梁\n
👀 Tên: Phạm Minh Việt ( Vịt )
❎ Tuổi: 12 🦆
👤 Giới tính: Bede
💫 Chiều cao cân nặng: 1m51 x 35kg
💘 Mối quan hệ: Độc Thân
🌎 Quê quán: Nghệ An ( Hoàng Mai, NA - 37 )
👫 Gu: Biết nấu cơm.
🌸 Tính cách: Chả biết nữa =))
🌀 Sở thích: Thích sờ mông các bạn nữ ulala.
💻Contact💻
☎ SĐT&Zalo:033.779.5479
🌐 Facebook: https://www.facebook.com/Profile.PhamMinhViett
✉️ Email: thanhxuancuavietvaem@gmail.com`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${1049943292}/picture?height=720&width=720&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`)).pipe(
