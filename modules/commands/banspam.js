module.exports.config = {
  ...
  description: "tự động cấm người dùng nếu spam bot 10 lần/100s",
...
module.exports.handleEvent = async function ({ api, event, args, Users,Threads })  {
  ...
  if ((global.client.autoban[senderID].timeStart + 120000) <= Date.now()) {
    ...
    `❌ Người dùng ${dataUser.name} đã bị cấm sử dụng Bot !\n⚡ Lý do: spam bot 10 lần/2 phút\nĐã báo cáo đến admin ✔️`, threadID,
    () => {
    var idad = global.config.ADMINBOT;
    for(let ad of idad) {
        api.sendMessage(`❮ Thông báo vi phạm ❯\n\n💦 Người vi phạm: ${dataUser.name}\n💧 UID: ${senderID}\n❄️ ThreadID: ${idbox}\n⚡ Threadname: ${namethread}\n🚫 Lý do: Spam bot 10 lần/2 phút\n----------------
⏰ Thời gian: ${timeDate}`,
          ad, (error, info) =>
